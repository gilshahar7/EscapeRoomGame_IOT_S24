...
const fixedPositions = [
  ...
  { name: "Sikstee", position: [0.4 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.2 * SCALE_FACTOR, 0.5 * SCALE_FACTOR] },
  { name: "Vega", position: [0.7 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.2 * SCALE_FACTOR, -0.4 * SCALE_FACTOR] },
  ...
  { name: "Sirius", position: [-0.4 * SCALE_FACTOR * X_STRETCH_FACTOR, 0.5 * SCALE_FACTOR, -0.4 * SCALE_FACTOR] },
  ...
  { name: "Altair", position: [-0.6 * SCALE_FACTOR * X_STRETCH_FACTOR, -0.5 * SCALE_FACTOR, -0.3 * SCALE_FACTOR] },
